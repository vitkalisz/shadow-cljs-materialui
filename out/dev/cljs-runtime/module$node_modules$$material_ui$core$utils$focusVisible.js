shadow$provide.module$node_modules$$material_ui$core$utils$focusVisible=function(global,require,module,exports){function handleKeyDown(event){event.metaKey||event.altKey||event.ctrlKey||(hadKeyboardEvent=!0)}function handlePointerDown(){hadKeyboardEvent=!1}function handleVisibilityChange(){"hidden"===this.visibilityState&&hadFocusVisibleRecently&&(hadKeyboardEvent=!0)}function isFocusVisible(event){event=event.target;try{return event.matches(":focus-visible")}catch(error){}var JSCompiler_temp;if(!(JSCompiler_temp=
hadKeyboardEvent)){JSCompiler_temp=event.type;var tagName=event.tagName;JSCompiler_temp="INPUT"===tagName&&inputTypesWhitelist[JSCompiler_temp]&&!event.readOnly||"TEXTAREA"===tagName&&!event.readOnly||event.isContentEditable?!0:!1}return JSCompiler_temp}function handleBlurVisible(){hadFocusVisibleRecently=!0;window.clearTimeout(hadFocusVisibleRecentlyTimeout);hadFocusVisibleRecentlyTimeout=window.setTimeout(function(){hadFocusVisibleRecently=!1},100)}global=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");
