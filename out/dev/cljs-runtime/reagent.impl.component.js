...
if((i < len)){
var k = (ks[i]);
var G__35855 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__35856 = (i + (1));
m = G__35855;
i = G__35856;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__35690 = p.children;
return module$node_modules$react$index.Children.toArray(G__35690);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35695 = c;
var G__35695__$1 = (((G__35695 == null))?null:G__35695.prototype);
if((G__35695__$1 == null)){
return null;
} else {
return G__35695__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35701 = c;
var G__35701__$1 = (((G__35701 == null))?null:G__35701.prototype);
if((G__35701__$1 == null)){
return null;
} else {
return G__35701__$1.render;
}
})() == null)))));
});
...
var G__35706 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35706) : reagent.impl.component.as_element.call(null,G__35706));
};
...
var _STAR_current_component_STAR__orig_val__35707 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35708 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35708);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35707);
}});
...
var c = this;
var G__35756_35955 = goog.object.get(c,"cljsRatom");
if((G__35756_35955 == null)){
} else {
reagent.ratom.dispose_BANG_(G__35756_35955);
}
...
var renders_35963 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_35964 = cljs.core.first(cljs.core.vals(renders_35963));
...
if((cljs.core.count(renders_35963) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_35963))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_35964)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_35964], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__35787 = o;
var G__35788_35983 = G__35787;
var G__35789_35984 = cljs.core.name(k);
var G__35790_35985 = v;
goog.object.set(G__35788_35983,G__35789_35984,G__35790_35985);
...
var G__35805_35999 = cmp.prototype;
var G__35806_36000 = module$node_modules$react$index.Component.prototype;
var G__35807_36001 = methods$;
goog.object.extend(G__35805_35999,G__35806_36000,G__35807_36001);
...
var name = (function (){var G__35820 = fiber;
var G__35820__$1 = (((G__35820 == null))?null:G__35820.type);
if((G__35820__$1 == null)){
return null;
} else {
return G__35820__$1.displayName;
}
})();
var parent = (function (){var G__35822 = fiber;
if((G__35822 == null)){
return null;
} else {
return G__35822.return;
}
})();
var path = (function (){var G__35823 = parent;
var G__35823__$1 = (((G__35823 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__35823) : reagent.impl.component.fiber_component_path.call(null,G__35823)));
if((G__35823__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35823__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__35830 = c;
if((G__35830 == null)){
return null;
} else {
return goog.object.get(G__35830,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__35831._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__35837 = c;
if((G__35837 == null)){
return null;
} else {
return goog.object.get(G__35837,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__35839 = c;
if((G__35839 == null)){
return null;
} else {
return G__35839._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__35841 = instance;
if((G__35841 == null)){
return null;
} else {
return goog.object.get(G__35841,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__35842 = instance;
if((G__35842 == null)){
return null;
} else {
return G__35842._currentElement;
}
}
})();
var name = (function (){var G__35844 = elem;
var G__35844__$1 = (((G__35844 == null))?null:G__35844.type);
if((G__35844__$1 == null)){
return null;
} else {
return G__35844__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__35846 = elem;
if((G__35846 == null)){
return null;
} else {
return goog.object.get(G__35846,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__35847._owner;
}
}
})();
var path = (function (){var G__35848 = owner;
var G__35848__$1 = (((G__35848 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__35848) : reagent.impl.component.component_path.call(null,G__35848)));
if((G__35848__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35848__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__35849 = c;
var G__35849__$1 = (((G__35849 == null))?null:G__35849.constructor);
if((G__35849__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__35849__$1);
}
}
})();
